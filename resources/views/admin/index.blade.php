    ...
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="{{url('media/add')}}">素材管理--添加</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="{{url('media/list')}}">素材管理--列表展示</a>
                            </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="{{url('ticket/add')}}">渠道管理--添加</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="{{url('ticket/list')}}">渠道管理--列表展示</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="{{url('ticket/chart')}}">渠道管理--图表展示</a>
                            </li>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe id="J_iframe" width="100%" height="100%" src="index_v1" frameborder="0" data-id="index_v1.html" seamless></iframe>
            </div>
        </div>
        <!--右侧部分结束-->
